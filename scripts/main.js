 ...
 * PLATFORMS
 */
let twitchPlatform = new Plataforma("Twitch", "https://upload.wikimedia.org/wikipedia/commons/1/19/Twitch.jpg", "Twitch is an interactive livestreaming service for content spanning gaming, entertainment, sports, music, and more. There's something for everyone on ..", "Amazon, Inc.");
let youTuBePlatform = new Plataforma("Youtube", "https://1000marcas.net/wp-content/uploads/2020/02/Logotipo-negro-de-YouTube.png", "YouTube es un sitio web de origen estadounidense dedicado a compartir videos. Presenta una variedad de clips de películas, programas de televisión y vídeos musicales, así como contenidos amateur como videoblogs y YouTube Gaming", "Google");
let facebookLivePlatform = new Plataforma("Facebook Live", "https://assets.stickpng.com/thumbs/585e4da1cb11b227491c339c.png", "Usa Facebook para transmitir en vivo una conversación, un espectáculo, una sesión de preguntas y respuestas o un evento virtual. Puedes transmitir en vivo ...", "Meta");
 ...
 * STREAMERS
 */
let streamer1 = new Streamer("Ibai Llanos", "Ibai Llanos Garatea es un streamer, youtuber y presentador de deportes electrónicos español.​​En Twitch cuenta con más de 11 millones de seguidores, lo que le coloca en el cuarto puesto global de los canales con más seguidores de la plataforma.​", ["https://twitter.com/IbaiLlanos", "https://fb.com/IbaiLlanos", "https://linkedin.com/IbaiLlanos"]);
let streamer2 = new Streamer("Auron", "Traducción del inglés-Raúl Álvarez Genes, más conocido como AuronPlay o simplemente Auron, es un YouTuber, streamer de Twitch y comediante español.​", ["https://twitter.com/auronplay"]);
let streamer3 = new Streamer("Nate Gentile", "José Ignacio Gentile, ​ más conocido como Nate Gentile es un youtuber uruguayo con más de dos millones de suscriptores en su canal homónimo dedicado a la informática doméstica, especialmente al análisis y montaje de potentes equipos y componentes.​", ["https://www.youtube.com/@NateGentile7", "https://twitter.com/nategentile7"]);
 ...
 * CHANNELS
 */
let canal1 = new Canal("Ibai Sports", "https://bannerEsportsIbaiLlanos.png", "Canal dedicado a deportes, eventos relacionados, narración y streaming de eventos deportivos blah blah", streamer1, twitchPlatform);
let canal2 = new Canal("Ibai Gaming", "https://bannerGamingIbaiLlanos.png", "Canal dedicado a gameplays y blah blah", streamer1, twitchPlatform);
let canal3 = new Canal("Ibai E-Sports", "https://bannerEsportsIbaiLlanos.png", "Canal dedicado a deportes, eventos relacionados, narración y streaming de eventos deportivos blah blah", streamer1, youTuBePlatform);
let canal4 = new Canal("Auron Gaming", "https://bannerAuronGaming.png", "Canal dedicado a gameplays en directo y blah blah", streamer2, twitchPlatform);
let canal5 = new Canal("Auron Chatting", "https://bannerChattingAuron.png", "Canal dedicado a chatting", streamer2, twitchPlatform);
let canal6 = new Canal("Auron Gaming", "https://bannerAuronGaming.png", "Canal dedicado a gameplays onDemand y blah blah", streamer2, youTuBePlatform);
let canal7 = new Canal("Nate", "https://bannerTechReviewsNate.png", "Canal dedicado a Tech reviews y avances tecnológicos de la industria", streamer3, twitchPlatform);
let canal8 = new Canal("Nate", "https://bannerTechReviewsNatefb.png", "Canal dedicado a Tech reviews y avances tecnológicos de la industria", streamer3, facebookLivePlatform);
let canal9 = new Canal("Nate", "https://bannerTechReviewsNateYoutube.png", "Canal dedicado a Tech reviews y avances tecnológicos de la industria - OnDemand y LiveStream", streamer3, youTuBePlatform);
/**
 * CATEGORIES
 */
 ...
 */
let patreonPlatform = new Plataforma("Patreon", "https://logpatreon.png", "Patreon is the best place for creators to build memberships by providing exclusive access to their work and a deeper connection with their communities.", "Jack Conte Music Records");
app.agregarPlataforma(patreonPlatform);
console.log(app.plataformas);
/**
 * 10. Agregar un Canal
 */
let canal10 = new Canal("Solo Music", "https://solomusic.png", "Solo music creative project for famous songs", streamer3);
